class Scene3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("background2", 'image/background/Environment/bg2.png');
    ...
    create() {
        ...
        this.add.image(480,0,"background2").setOrigin(0);
        this.add.image(0,270,"background2").setOrigin(0);
        this.add.image(480,270,"background2").setOrigin(0);
        this.add.image(0,540,"background2").setOrigin(0);
        this.add.image(480,540,"background2").setOrigin(0);
