class Scene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("background", 'image/background/Environment/bg.png');
    ...
    create() {
        ...
        this.add.image(480,0,"background").setOrigin(0);
        this.add.image(0,270,"background").setOrigin(0);
        this.add.image(480,270,"background").setOrigin(0);
        this.add.image(0,540,"background").setOrigin(0);
        this.add.image(480,540,"background").setOrigin(0);



        this.score = 0;
        //分數文字
        this.scoreText = this.add.text(10, 10, "這裡是scene Score:", {
            fontSize: 50,
            fill: "white"
        });
        ...
        this.teleporter = this.add.sprite(750, 500,"tp");
