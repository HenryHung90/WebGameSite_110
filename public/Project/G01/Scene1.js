class Scene1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("background19", 'image/background/Environment/bg-night.png');
    ...
    create() {
        ...
        this.add.image(0,0,"background19").setOrigin(0);
        this.add.image(480,0,"background19").setOrigin(0);
        this.add.image(0,270,"background19").setOrigin(0);
        this.add.image(480,270,"background19").setOrigin(0);
        this.add.image(0,540,"background19").setOrigin(0);
        this.add.image(480,540,"background19").setOrigin(0);
        ...
        this.anims.create({
            key: 'action',
            frames: this.anims.generateFrameNumbers('tp', { start: 1, end: 15 }),
            frameRate: 10,
            repeat: -1
        });

        this.stones = this.physics.add.staticGroup();
        this.stones.create(145, 256, 'stone1');
        this.stones.create(302, 216, 'stone2'); 
        this.stones.create(487, 309, 'stone3'); 
        this.stones.create(555, 422, 'stone4'); 
        this.stones.create(679, 101, 'stone5');
        this.stones.create(254, 179, 'stone5'); 
        this.stones.create(402, 511, 'stone5');
        this.stones.create(309, 405, 'stone2'); 
        this.stones.create(222, 221, 'stone3');

        this.gresses = this.physics.add.staticGroup();
        this.gresses.create(145, 256, 'gress1');
        this.gresses.create(302, 216, 'gress2');
        this.gresses.create(487, 309, 'gress3');
        this.gresses.create(555, 422, 'gress4');
        this.gresses.create(679, 101, 'gress5');
        this.stones.create(254, 179, 'gress5'); 
        this.stones.create(381, 511, 'gress5');
        this.stones.create(300, 401, 'gress2'); 
        this.stones.create(222, 221, 'gress3');
